<?php
if ( !function_exists('mtheme_google_fonts') ) {
function mtheme_google_fonts() {
$google_api_output='
{
 ...
 "items": [
  ...
  },
  {
   ...
   "lastModified": "2015-09-09",
   "files": {
    "regular": "http://fonts.gstatic.com/s/notoserif/v5/zW6mc7bC1CWw8dH0yxY8JfesZW2xOQ-xsNqO47m55DA.ttf",
    "italic": "http://fonts.gstatic.com/s/notoserif/v5/HQXBIwLHsOJCNEQeX9kNzy3USBnSvpkopQaUR-2r7iU.ttf",
    "700": "http://fonts.gstatic.com/s/notoserif/v5/lJAvZoKA5NttpPc9yc6lPQJKKGfqHaYFsRG-T3ceEVo.ttf",
    "700italic": "http://fonts.gstatic.com/s/notoserif/v5/Wreg0Be4tcFGM2t6VWytvED2ttfZwueP-QU272T9-k4.ttf"
   }
  },
  {
   "kind": "webfonts#webfont",
...
foreach ($items as $item) {
	...
	if (isSet($item['subsets'])) {
		...
		foreach ($item['subsets'] as $subset) {
			$subsetCount++;
			if ($subsetCount>1) { $subsets .= '|'; }
			$subsets .= $subset;
		}
	}
	$variantText = ' (' . $variantCount . ' Varaints' . ')';
	if ($variantCount <= 1) $variantText = '';
	$options_fonts[ $item['family'] . ':' . $variants . ':' . $subsets ] = $item['family']. $variantText;
}
