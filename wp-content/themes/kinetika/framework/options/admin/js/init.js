jQuery(document).ready( function($) {
  ...
  /**
    * Google Fonts
    * Dependencies   : google webfont, jquery
  ...
  function GoogleFontSelect( slctr, mainID ){
    ...
    var _previewer = mainID +'_googlefont_previewer';
    ...
    if( _selected ){
      ...
      if ( _selected !== '0' && _selected !== 'Default Font' ) {
        ...
        $('head').append('<link href="http://fonts.googleapis.com/css?family='+ the_font +'" rel="stylesheet" class="'+ _linkclass +'">');
  ...
  $('.themeoptions-loading').fadeOut('fast');
  $('.options_wrap').show();
   ...
   $('#submit-options-ajax').live("click", function(){
      ...
      setTimeout("jQuery('#saveMessage,#errorMessage').fadeOut();", 4000);
