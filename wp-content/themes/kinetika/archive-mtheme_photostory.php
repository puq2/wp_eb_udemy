...
$archive_pagination=of_get_option('photostory_archive_pagination');
...
echo do_shortcode('[gallerygrid displaycategory="false" desc="true" worktype_slugs="'.$worktype.'" format="'.$format.'" type="default" limit="'.$archive_pagination.'" pagination="true" columns="'.$columns.'"]');
?>
</div>
<?php get_footer(); ?>