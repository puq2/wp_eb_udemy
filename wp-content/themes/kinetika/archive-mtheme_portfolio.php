...
echo do_shortcode('[portfoliogrid worktype_slugs="'.$worktype.'" boxtitle="false" format="'.$format.'" type="default" limit="-1" pagination="true" columns="'.$columns.'" title="true" desc="true"]');
?>
</div>
<?php get_footer(); ?>